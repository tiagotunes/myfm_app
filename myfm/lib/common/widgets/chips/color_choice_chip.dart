      ...
      children: [
        ...
        Obx(
          () => ColorIndicator(
            ...
            height: TSizes.colorIndicatorHeight,
            ...
            onSelect: () {
              ColorPicker(
                ...
                heading: const Text(TTexts.selectColor),
                subheading: const Text(TTexts.selectColorShade),
                ...
                borderRadius: TSizes.borderRadiusMd,
                wheelDiameter: TSizes.wheelDiameter,
                wheelWidth: TSizes.wheelWidth,
                wheelSquarePadding: TSizes.sm,
                wheelSquareBorderRadius: TSizes.borderRadiusMd,
                wheelHasBorder: true,
                wheelSubheading: const Text(TTexts.selectColorShade),
                showColorCode: true,
